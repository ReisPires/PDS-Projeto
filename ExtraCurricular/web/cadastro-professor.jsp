...
<html>
    <head>
        <meta charset="utf-8">
        <title>Sistema London - Cadastro de Professor</title>
    ...
    <body>
        <div class="cabecalho">
            <div class="container">
                ...
                <div class="pagina pagina-centro">Cadastro de Professor</div>
            </div>
        </div>        
        <div class="corpo">
            <div class="container">
                <div class="frame">
                    <div class="painel">                                       
                        <form class="formulario" action="cadastrarProfessor" method="post">
                            <label class="label" for="codigo" style="width: 150px">Código</label>                            
                            <label class="label" for="nome">Nome</label>
                            
                            <br style="clear:both" />
                            
                            <input class="campo" id="codigo" name="codigo" maxlength="10" style="width: 150px" type="text" spellcheck="false" required>                                       
                            <input class="campo" id="nome" name="nome" maxlength="100" style="width:794px" type="text" spellcheck="false" required>
                            ...
                            <div class="botoes" style="clean: both">
                                <% if (resultadoCadastro != null) { %>
                                    <% if (resultadoCadastro == 0) { %>                                        
                                        <label class="success-msg">Professor cadastrado com sucesso</label>                                        
                                    <% } else if (resultadoCadastro == 12) { %>
