    ...
    <body>
        <div class="janela">
            ...
            <form action="cadastrarAluno" method="post">                
                ...
                <div class="grupo">
                    <div><label for="matricula">Matrícula:</label></div>
                    <div><input id="matricula" name="matricula" type="text"/></div>
                </div>
                <div class="grupo">
                    <div><label for="turma">Turma:</label></div>
                    <div><input id="turma" name="turma" type="text"/></div>
                </div>                
                <div class="grupo">
